...
1. Identify the Desired Outcome: Define what success looks like for your project.
    - A detailled 7-day travel itinerary
...
class TripTasks:
    ...
    def plan_itinerary(self, agent, city, travel_dates, interests):
        return Task(
            ...
            **Description**: Expand the city guide into a full 7-day travel itinerary with detailled
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        return Task(
            ...
            **Description**: Analyze and select the best city for the trip based on specific 
                criteria such as the weather patterns, seasonal events, and travel costs.
